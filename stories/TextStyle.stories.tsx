...
const TextStyleLayout: React.FC = () => {
  ...
  Try us out for free, when your ready move up to our everyday plan. If things are getting serious, go pro. 
      </Box>
   

      <Box sx={{ variant: `text.${TextStyleNames.paragraph}` }}>
        <p>
         You can always switch the billing interval, or change your plan. And of course, cancel anytime
        </p>
      </Box>
      ...
      <Box sx={{ variant: `text.${TextStyleNames.action}` }}>
        Click me
      </Box>
    </Flex>
  )
...
const Template: ComponentStory<typeof TextStyleLayout> = (args) => <TextStyleLayout {...args} />
